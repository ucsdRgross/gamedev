...
**Why:** each rejection costs a full implement-then-redesign cycle — a normal-based tendril spec was
thrown out as shape-specific, and an FX plan was rewritten three times over sibling coupling. The
