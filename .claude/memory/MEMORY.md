...
- [Spotlight design + phase 1](solatro-spotlight-design.md) — design CONFIRMED 2026-08-03, now **v12**; **ALL FOUR PHASES BUILT — every step S1–S18 done** (S15/S16/S17 landed 2026-08-05); all 9 gaps closed; **only GATES + 2 open bugs remain**; GAP-009 made the row opening a knob, not a derivation; status ledger is solatro/HANDOFF_spotlight.md
