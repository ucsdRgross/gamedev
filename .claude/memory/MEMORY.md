...
- [Spotlight design + phase 1](solatro-spotlight-design.md) — design CONFIRMED 2026-08-03, **v12**; **ALL FOUR PHASES BUILT — S1–S18 done, suite green, partly committed in 9cb8f59, rest dirty** (2026-08-06); 9 gaps closed; G2.2+G3.3 still open; **15 defects fixed 2026-08-05/06, all green-when-shipped — forensics in ARCHITECTURE_REVIEW.md §9**; status ledger is solatro/HANDOFF_spotlight.md
