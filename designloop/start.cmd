@echo off
REM Double-click this file to run the Design Loop tool (PLAN S1 — no command line).
REM It starts the local server and opens the index in your browser. Close this window to stop.
...
echo Starting Design Loop... your browser will open in a moment.
...
node src/server.mjs --open --replace
