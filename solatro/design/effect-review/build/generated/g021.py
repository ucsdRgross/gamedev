...
("M0016", "The Chorus Line", "Y2", "skill",
 ...
 "When two marks in one line are matched in the same placement, both their mark effects fire twice",
 "When every mark in one line is matched, each of their mark effects fires again",
 "Matching a mark also fires the mark effect of the cell to its left",
 "b"),
...
("M0027", "The Rolling Call", "Y4", "skill",
 ...
 "Every time you match a mark, an unmarked cell is dealt a new mark",
 "Every time you match a mark, the NEXT card in the Entrance is marked onto an empty cell",
 "Every time you FAIL to match, an unmarked cell is dealt a new mark",
 "b"),
...
("M0031", "The Loose Blocking", "Y5", "skill",
 ...
 "A card also matches the mark of the cell directly above it in the grid, as well as its own",
...
("M0032", "The Colour Match", "Y5", "skill",
 ...
 "A card matches a mark's suit if the two suits share a prop family, not only if they are the same suit",
 "A card always matches a mark's suit, and the suit bonus is halved for everyone",
...
("M0035", "The Cut Number", "Y6", "skill",
 ...
 "A show ending with any unmatched mark cannot earn a perfect bonus",
 "c"),
