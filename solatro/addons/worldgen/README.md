...
> **Vendored snapshot.** The canonical home of this addon is the `worldgen` project in
> this repo (`worldgen/addons/worldgen/`). Do not edit this copy — make changes there
> and re-copy the whole directory here.
