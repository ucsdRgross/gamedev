...
| `l_mid_base` | 0.30–0.92 *(max raised from 0.80)* | Where foreground midtones sit — the **darkness/brightness** master knob. The old 0.80 ceiling made high-key palettes impossible and blocked centring a ramp on the gamut cusp for the whole yellow→cyan arc (cusps at L 0.86–0.96). See COLOR_GUIDE.md. |
...
> **Changed by the repo owner, superseding what this section originally said.**
